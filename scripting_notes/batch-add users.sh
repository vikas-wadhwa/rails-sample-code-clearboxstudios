...
delete from users where id > 127338;
ALTER SEQUENCE users_id_seq RESTART WITH 127339;

delete from profiles where id > 127523;
ALTER SEQUENCE profiles_id_seq RESTART WITH 127524;

delete from accounts where id > 127429;
ALTER SEQUENCE accounts_id_seq RESTART WITH 127430;

delete from account_users where id > 127408;
ALTER SEQUENCE account_users_id_seq RESTART WITH 127409;

delete from projects where id > 127341;
ALTER SEQUENCE projects_id_seq RESTART WITH 127342;

delete from project_users where id > 180;
ALTER SEQUENCE project_users_id_seq RESTART WITH 181;

delete from project_photos where id > 170;
ALTER SEQUENCE project_photos_id_seq RESTART WITH 171;

delete from tasks where id > 127428;
ALTER SEQUENCE tasks_id_seq RESTART WITH 127429;

delete from invoices where id > 127158;
ALTER SEQUENCE invoices_id_seq RESTART WITH 127159;
...
userList = [
  {company_name: '', name_first: 'Brandi', name_last:  'White', email: 'brandizipsie@gmail.com'}
]
...
userModel = User.find_by_email('aarohi@page-vault.com')
userModel.password = 'password1234'
userModel.password_confirmation = 'password1234'
userModel.save!	

userModel = User.find_by_email('josh@wellter.com')
userModel.password = 'password1234'
userModel.password_confirmation = 'password1234'
userModel.save!	

userModel = User.find_by_email('patrick@page-vault.com')
userModel.password = 'password1234'
userModel.password_confirmation = 'password1234'
userModel.save!	


userModel = User.find_by_email('stephen@page-vault.com')
userModel.password = 'password1234'
userModel.password_confirmation = 'password1234'
userModel.save!	
...
app.post('/login', {"user"=>{"login"=>"ethan.linkner@learncore.com", "password"=>"password1234"}})
app.delete('/logout')
...
#########################################################################
	...
	accountData = {}
	accountData[:name]= 'Brandi White'
	accountData[:permissions]= 220
	accountData[:company_name]= ''
	accountData[:company_website]= ''
	accountData[:company_address_street]= ''
	accountData[:company_address_city]= ''
	accountData[:company_address_state]= ''
	accountData[:company_address_zip]= ''
	accountData[:company_phone]=''
	accountData[:billing_name]= 'Brandi White'
	accountData[:billing_email]= 'brandizipsie@gmail.com'
...
{create_user: true, account: { name: 'Brandi White', billing_name: 'Ethan Linkner', billing_email: 'ethan.linkner@learncore.com', company_name: 'Catapult Chicago', company_address_street: '321 North Clark Street #2550', company_address_city: 'Chicago', company_address_state: 'Chicago', company_address_zip: 'Chicago', company_phone: 'Chicago' , company_website: '312-860-0950' }, project_users: '', name_first: 'Ethan', name_middle: '', name_last:  'Linkner', email: 'ethan.linkner@learncore.com'},
]
